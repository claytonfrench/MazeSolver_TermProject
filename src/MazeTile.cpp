 ...
 * @param north is true if there is a wall above the cell
 * @param south is true if there is a wall below the cell
 * @param east is true if there is a wall to the right of the cell
 * @param west is true if there is a wall to the left of the cell
